...
const HistoryScreen = () => {
    ...
    const fetchRequests = async () => {
        try {
            const response = await API.get('/api/admin/requests'); // Assuming admin routes return their history or all requests
            // Just basic fallback handling
            if (response.data) {
    ...
    return (
        <SafeAreaView style={styles.safeArea}>
            ...
            <View style={styles.container}>
                ...
                <Text style={styles.subtitle}>Review past outpass requests processed by administration.</Text>
                        ...
                        return (
                            <View style={styles.requestCard}>
                                ...
                                <View style={styles.dateRow}>
                                    ...
                                    <Text style={styles.dateValue}>{item.fromDate ? new Date(item.fromDate).toLocaleDateString() : 'N/A'}</Text>
                                </View>
                            </View>
                        );
                    }}
